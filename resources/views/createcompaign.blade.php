...
<body>
  ...
  Templates
   ...
   <input type="email" id="exampleFormControlInput1" placeholder="name@example.com" class="form-control">
   </div> 
   <div class="form-group">
   <label for="exampleFormControl1">Subject</label>
    <input type="text" id="exampleFormControl1" placeholder="subject" class="form-control">
   </div>
   <div class="form-group">
   </div>
   <div style="margin-bottom: 2%;">
    <a href="/Create new templates" type="button" class="btn btn-dark btn-lg">+templates</a>
   <button type="button" class="btn btn-success btn-lg">Save templates</button>
   </div> 
   <div class="form-group">
   <label for="exampleFormControlTextarea1">Content</label> 
   <textarea id="exampleFormControlTextarea1" rows="8" class="form-control"></textarea>
   </div> 
   </form>
